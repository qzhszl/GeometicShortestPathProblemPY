...
for ExternalSimutime in range(3):

    inputsigma = sigma_vec[ExternalSimutime]

    FileNetworkName = "nonunit_network_N{Nn}avg{EDn}Beta4sigma{sigma}.txt".format(
        Nn=N, EDn=ED,sigma = inputsigma)

    print(FileNetworkName)