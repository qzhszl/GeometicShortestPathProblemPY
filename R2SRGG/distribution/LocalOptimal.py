...
def avedistance_inSRGG(network_size_index, average_degree_index, beta_index, simu_time):
    Nvec = [10, 20, 50, 100, 1000, 10000]
    kvec = list(range(2, 16)) + [20, 25, 30, 35, 40, 50, 60, 70, 80]
    simu_times = 100
...
if __name__ == '__main__':
    ...
    beta_index = 0
    simu_time = 0
    avedistance_inSRGG(network_size_index, average_degree_index, beta_index, simu_time)
