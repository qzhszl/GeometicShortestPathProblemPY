...
def load_large_network_results(N, beta, kvec):
    ...
    print(exemptionlist)
    return kvec, ave_deviation_vec, std_deviation_vec, ave_edgelength_vec, std_edgelength_vec, ave_hop_vec, std_hop_vec, ave_L_vec, std_L_vec
...
def plot_devandL_withED():
    ...
    if N == 1000:
        ...
        kvec = [2, 3, 4, 6, 11, 20, 37, 67, 121, 218, 392, 705, 1267, 2275, 4086, 7336, 13169, 23644,29999]
    ...
    kvec, ave_deviation_vec, std_deviation_vec, ave_edgelength_vec, std_edgelength_vec, ave_hop_vec, std_hop_vec, ave_L_vec, std_L_vec = load_large_network_results(
        N, beta, kvec)
    ...
    plt.errorbar(kvec, ave_deviation_vec, yerr=std_deviation_vec, linestyle="-", linewidth=3, elinewidth=1, capsize=5,
                 marker='o', markersize=16,
                 label=r"$\langle d \rangle$", color=colors[0])
    plt.errorbar(kvec, ave_L_vec, yerr=std_L_vec, linestyle="-", linewidth=3, elinewidth=1, capsize=5,
                 marker='o', markersize=16,
