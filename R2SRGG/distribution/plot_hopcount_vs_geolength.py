...
def plot_hopcount_vs_geolength(N, ED, beta):
    ...
    geodesic_distance_AB_list = [0.01,0.3,0.5]
    ...
    for geodesic_distance_AB in geodesic_distance_AB_list:
        ...
        plt.hist(SP_hopcount, bins=bins,alpha=0.7, color=colors[count], edgecolor=colors[count],density=True, label=f"geodesic length: {geodesic_distance_AB}")  # 绘制直方图
